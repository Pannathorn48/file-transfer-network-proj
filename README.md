...
- `TIMEOUT_MSEC`: 3000ms
- `TEST_SENDER_PACKET_LOSS_PERCENTAGE` : 1\%
- `TEST_SENDER_PACKET_CORRUPTION_PERCENTAGE` : 10\%
- `TEST_SENDER_DUPLICATE_PACKET_PERCENTAGE` : 1\%
- `TEST_RECEIVER_PACKET_LOSS_PERCENTAGE` : 1\%